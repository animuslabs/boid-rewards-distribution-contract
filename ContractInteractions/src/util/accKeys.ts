...
// Example usage  
// checkAccountInfo("mainnet", "scores.boid", "token.boid", "BOID").then(console.log).catch(console.error);
// checkAccountInfo("testnet", "xsend.boid", "token.boid", "BOID").then(console.log).catch(console.error);

// (async () => {
//     try {
//         const acc = "scores.boid";
...
//         keys: [
//             {
//                 key: "EOS59YihVB2JBHFbPC9kqqiDKJjRuMRMcS68STqHWGAeFkFnxH5Cz",
//                 weight: 1
//             }
//         ],
//         accounts: []
...
//                 permission: Name.from("report"),
//                 parent: Name.from("active"),
//                 auth
//             };
//         createAndSendAction(
//             "mainnet",
